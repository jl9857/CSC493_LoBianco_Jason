...
/**
 * The BunnyHead class is responsible for creating and maintaining the 
 * bunnyhead asset in the game.
...
public class BunnyHead extends AbstractGameObject
{
	...
	/**
	 * sets the jump state of the bunny head.
	...
	/**
	 * sets hasFeatherPowerup and if true sets the duration of the
	 * power up.
	 * @param pickedUp
	 */
	...
	/**
	 * returns true if the bunnyhead has the feather powerup and there
	 ...
	 * and checks if there is remaining time on the feather power up.
	 */
	@Override
	...
	/**
	 * draws the image of the bunny head for the game.
	 */
	@Override
